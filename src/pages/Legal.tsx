        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            <ScrollReveal delay={100}>
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-gray-700">
                ...
                <div className="text-gray-300 space-y-4 leading-relaxed">
                  <p>Vždy s vámi uzavřu DPP (Dohoda o provedení práce), což je legální dokument, který potvrzuje, že mě “najímáte” např. na tvorbu webových stránek, nebo jinou službu, se kterou vám pomohu. 
</p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={150}>
              <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-gray-700">
                <h2 className="text-3xl font-bold mb-6">Ochrana osobních údajů</h2>
                <div className="text-gray-300 space-y-4 leading-relaxed">
