        ...
        <div className="max-w-4xl mx-auto">
          ...
          <ScrollReveal delay={100}>
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-gray-700 mb-16">
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-8">Vytvářím webové stránky od jednoduchých prezentačních webů, až po komplexní s rezervačními systémy a pokročilými funkcemi. Cena individuální podle toho co vše na webu budete chtít, může se pohybovat mezi 4 000-12 000 kč.</p>
