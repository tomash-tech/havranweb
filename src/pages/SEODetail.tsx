        ...
        <div className="max-w-4xl mx-auto">
          ...
          <ScrollReveal delay={100}>
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-gray-700 mb-16">
              ...
              <p className="text-xl text-gray-300 leading-relaxed mb-8">SEO je optimalizace vašeho podniku pro vyhledávače jako Google, to znamená že když si někdo vyhledá váš obor ve vašem městě, zobrazíte se hned nahoře (viz foto dole), Proč je to důležité? když si někdo vyhledá npř. kadeřnictví v Novém Jičíně, 70% lidí rozklikne jeden ze 3 prvních zobrazených podniků, zbylých 30% se podívá na ostatn.</p>
