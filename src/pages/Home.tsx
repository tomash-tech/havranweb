    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div className="md:col-span-1">
        ...
        <div className="flex items-center gap-3 mt-4">
          ...
          >
            ...
            href="https://www.linkedin.com/in/tom%C3%A1%C5%A1-havran/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition"
            style={{ backgroundColor: '#131929' }}
      ...
      <div>
        ...
        <ul className="space-y-2 text-gray-400 text-sm">
          <li><a href="/service/web-design" className="hover:text-cyan-400 transition">Web design</a></li>
          <li><a href="/service/seo" className="hover:text-cyan-400 transition">Lokální SEO</a></li>
          <li><a href="/service/eshops" className="hover:text-cyan-400 transition">E-shopy</a></li>
        </ul>
      </div>
  ...
  <div className="border-t py-4" style={{ borderColor: 'rgba(34,211,238,0.2)' }}>
    <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-3 text-sm text-gray-500">
      ...
      <div className="flex items-center gap-4">
        <a href="/legal" className="hover:text-cyan-400 transition text-xs">Právní informace</a>
        <a href="/legal" className="hover:text-cyan-400 transition text-xs">Ochrana osobních údajů</a>
      </div>
    </div>
  </div>
</footer>
