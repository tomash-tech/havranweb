    ...
    <section id="sluzby" className="py-24 px-6 bg-gray-800/20">
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold mb-6">Co vám nabízím</h2>
...
<div className="grid md:grid-cols-3 gap-8">
  {[
    ...
    { icon: Code2, title: "Lokální SEO", desc: "Dostaňme váš podnik do top 3 na Goole pro vaše město, když zákazník vyhledá Npř Kadeřnictví Nový Jičín, váš podnik mu vyjede hned nahoře" },
    ...
    <ScrollReveal key={idx} delay={idx * 150}>
      <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-2xl border border-gray-700 hover:border-blue-500/50 transition-all hover:shadow-2xl hover:shadow-blue-500/10">
