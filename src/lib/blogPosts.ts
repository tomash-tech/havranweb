...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: "Proč každý lokální podnik potřebuje vlastní web v roce 2026",
...
{
  slug: "kolik-stoji-webove-stranky-novy-jicin",
  title: "Kolik stojí webové stránky v Novém Jičíně?",
  description: "Cena webu se liší podle toho, co potřebujete. Vysvětlíme, co ovlivňuje cenu a co vše moderní web může obsahovat.",
  date: "2026-04-24",
  category: "Tvorba webů",
  readTime: 5,
  content: `
## Kolik tedy web stojí?

Jedna z nejčastějších otázek, kterou dostáváme: *"Kolik mě bude stát web?"* Odpověď závisí na tom, co od webu očekáváte. Ceny se pohybují **od 4 000 do 12 000 Kč**, u složitějších projektů i více.

Nejde o to, že by někdo chtěl víc, než musí – jde o čas a práci, kterou konkrétní web vyžaduje. Jednoduchá vizitka pro živnostníka je něco jiného než vícejazyčný web s rezervačním systémem a napojením na Google tabulky.

## Co ovlivňuje cenu webu?

### Design a počet podstránek

Čím více stránek web má a čím propracovanější design požadujete, tím více práce to obnáší. Základní web může mít 3–5 podstránek (úvod, služby, o nás, kontakt). Větší projekty mívají i desítky podstránek s různými sekcemi.

### Funkce a napojení na externí systémy

Každá extra funkce přidává čas a tím i cenu. Nejčastěji řeší:

- **Rezervační systém** – zákazníci si sami online zarezervují termín, vy to vidíte v kalendáři
- **Napojení na Google tabulky** – objednávky nebo poptávky se automaticky zapisují do sdílené tabulky
- **Formuláře** – kontaktní, poptávkové, nebo třeba dotazníky
- **Google mapy** – zákazník hned vidí kde vás najde
- **Podpora více jazyků** – pokud cílíte i na zahraniční zákazníky

### Základní nebo pokročilé SEO

Každý web, který děláme, obsahuje základní SEO optimalizaci – správné nadpisy, meta popisky, rychlost načítání. Pokročilejší SEO (Vylepšení Google buisness profilu, Zmínky a citace) je pak samostatná služba.

## Co je součástí každého webu?

Bez ohledu na cenu dostanete vždy:

- **Přizpůsobivý design** – web vypadá skvěle na mobilu, tabletu i počítači
- **Rychlé načítání** – rychlost je důležitá jak pro uživatele, tak pro Google
- **Základní SEO optimalizaci** – správná struktura, nadpisy, meta tagy
- **Moderní technologie** – žádné zastaralé řešení, které za rok přestane fungovat

## Příklad: jak vypadá web za různou cenu?

**4 000 – 6 000 Kč** – jednoduchý web pro živnostníka nebo malou firmu. Úvod, služby, kontakt, Google mapa. Rychlý, přehledný, mobilní.

**6 000 – 10 000 Kč** – více podstránek, propracovanější design, kontaktní formulář, napojení na Google tabulky nebo základní rezervační systém.

**10 000 Kč a více** – komplexní projekty s rezervačním systémem, více jazyky, propojením s externími systémy nebo specifickými funkcemi na míru.

## Oplatí se to?

Web, který přivede jednoho nového zákazníka měsíčně, se zaplatí velmi rychle. A na rozdíl od reklamy na sociálních sítích – web pracuje za vás pořád, bez dalších nákladů.
...
},
{
  ...
  description: "Jedna posilovna v Novém Jičíně fungovala jen přes Facebook. Pro zákazníky bylo těžké zjistit otvírací dobu, ceny a fotky vybavení. Změnili jsme to.",
  date: "2026-04-30",
  category: "Tvorba webů",
  readTime: 4,
  content: `
...
Chcete zjistit otvírací dobu o svátcích. Není tam. Fotky vybavení? Pár starých fotek z roku 2018.
...
Podobný web můžeme vytvořit i pro vás. Ať už provozujete posilovnu, nebo jiný podnik v Novém Jičíně a okolí.
...
},
{
  ...
  readTime: 3,
  content: `
## Jak to funguje u většiny agentur?

Mnoho webových agentur a vývojářů účtuje měsíční poplatky za správu, hosting nebo údržbu webu. To může vyjít na stovky až tisíce korun měsíčně – a web technicky nikdy není váš, dokud platíte.

U nás to funguje jinak.

## U HavranWeb platíte jednorázově

Za tvorbu webu platíte jednou. Žádné měsíční poplatky, žádné předplatné, žádné skryté náklady. Web je váš.

Cena tvorby webu se pohybuje od **4 000 do 12 000 Kč** podle náročnosti projektu – počtu podstránek, funkcí a integracích které potřebujete. U složitějších projektů může být cena i vyšší.

## Hosting máte zdarma

Hosting – tedy místo na serveru kde váš web běží – zajišťujeme zdarma. Neplatíte nic navíc za to aby byl váš web dostupný online.

## Jediný náklad navíc je doména

Jediné za co platíte opakovaně je **doména** – tedy vaše webová adresa (např. vasefrima.cz). Ta vychází přibližně na **200 Kč ročně** a platíte ji přímo registrátorovi domény, ne nám.

## Přehled nákladů

- **Tvorba webu:** 4 000 – 12 000 Kč (jednorázově)
- **Hosting:** zdarma
- **Doména:** ~200 Kč / rok

To je vše. Žádné další měsíční poplatky.

## Co když budu chtít web upravit?

Drobné úpravy řešíme individuálně. Pokud víte že budete web chctít pravidelně upravovat, domluvíme se na poplatku za správu/prvidelnou úpravu webu. Vždy víte dopředu co vás bude stát.
...
},
{
  ...
  description: "Jednostránkový web, prezentační web, landing page nebo e-shop? Každý podnik potřebuje něco jiného. Podívejte se na 10 příkladů podle oboru a zjistěte co přesně potřebujete vy.",
  date: "2026-05-14",
  readTime: 9,
  category: "Webdesign",
  content: `
...
Jedna z nejčastějších chyb při objednávání webu je, že podnikatel ani neví jaký typ webu vlastně potřebuje. Někdo si nechá udělat složitý web s desítkami podstránek, přestože by mu stačila jednoduchá landing page. Jiný si objedná jednostránkový web a pak zjistí, že potřeboval i rezervační systém.
...
**Jednostránkový web** – jedna nebo dvě stránky. Kdo jste, co děláte, jak vás kontaktovat. Ideální pro živnostníky kteří potřebují jen základní online přítomnost a nepotřebují složité funkce.

**Landing page** – podobná jednostránkovému webu co do rozsahu, ale liší se účelem. Jednostránkový web prezentuje firmu obecně, landing page má jeden konkrétní cíl – přimět návštěvníka k jedné akci (vyplnit formulář, koupit produkt, přihlásit se na kurz). Neobsahuje navigaci ani rozptylující prvky. Vhodná pro kampaně, nové produkty nebo testování trhu.

**Jednoduchý prezentační web** – 3–5 podstránek, popis služeb, fotogalerie, kontaktní formulář. Žádné složité funkce. Nejběžnější volba pro živnostníky a menší firmy které potřebují solidní online přítomnost.

**Komplexnější web** – více podstránek, rezervační systém, napojení na Google tabulky, blog, lokální SEO podstránky pro více měst, více jazyků nebo jiné funkce na míru. Vhodný pro firmy s více službami nebo specifickými požadavky.
...
Jednostránkový web nebo jednoduchá landing page začíná na 4 000 Kč. Jednoduchý prezentační web se pohybuje od 6 000 do 8 000 Kč. Komplexnější web s pokročilými funkcemi od 8 000 do 12 000 Kč. E-shop s digitálními produkty od 10 000 Kč výše.
...
Výsledek? Pomalý web. A pomalý web znamená horší pozici na Googlu a zákazníky kteří odcházejí ještě před načtením stránky. Jak jsme psali v [článku o rychlosti webu](/blog/proc-pomaly-web-prichazi-o-zakazniky) - 53 % uživatelů na mobilu opustí web pokud se nenačte do 3 sekund.
...
Náš vlastní web havranweb.cz dosahuje skóre 98/100 v Google PageSpeed Insights na mobilu - více o tom proč na rychlosti záleží jsme psali v [článku o pomalých webech](/blog/proc-pomaly-web-prichazi-o-zakazniky). Typický Wix nebo WordPress web se pohybuje kolem 40–60. Tento rozdíl se přímo promítá do pozice ve výsledcích vyhledávání a počtu zákazníků které web přivede.
...
Pokud přemýšlíte o novém webu a chcete vědět co by bylo nejlepší řešení pro vaše podnikání, [ozvěte se nám](/kontakt) nebo si přečtěte více o [tvorbě webů na míru](/sluzby/webdesign). Konzultace je zdarma a nezávazná.
  `.trim(),
},
];
